...
local function draw_instructional_buttons()
    if cannon then
        if instructional:begin() then
            ...
            add_control_instructional_button(80, menuname('UFO', 'Disable Cannon'))
        ...
        if instructional:begin() then
            add_control_instructional_button(75, "BB_LC_EXIT")
            add_control_instructional_button(119, menuname('UFO', 'Vertical flight'))
            add_control_instructional_button(80, menuname('UFO', 'Cannon'))
			

            if #attracted > 0 then
                add_control_instructional_button(22, menuname('UFO', 'Release vehicles'))
            end

            if #attracted < 15 then
                add_control_instructional_button(73, menuname('UFO', 'Tractor beam'))
            end
